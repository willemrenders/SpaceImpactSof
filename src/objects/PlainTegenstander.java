...
class PlainTegenstander {
    ...
    public PlainTegenstander(int x, int y, int type) {
        ...
        dx = 2;
        tijd = 100;
        vliegtuigTegenstander = new ImageIcon(GUI.class.getResource("/images/plainTegenstander.png"));
        vliegtuigTegenstander02 = new ImageIcon(GUI.class.getResource("/images/plainTegenstander02.png"));
        vliegtuigTegenstander03 = new ImageIcon(GUI.class.getResource("/images/plainTegenstander03.png"));
        vliegtuigTegenstander04 = new ImageIcon(GUI.class.getResource("/images/plainTegenstander04.png"));
    }
